...
module.exports = {
  ...
  getNetamoToken: async (req, res) => {
    ...
    const scope = "read_station read_thermostat write_thermostat read_camera write_camera access_camera read_presence access_presence read_smokedetector read_homecoach";
